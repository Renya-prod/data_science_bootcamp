...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Counts (heads, tails):", heads, tails)

        head_frac, tail_frac = calculations.fractions(heads, tails)
        print("Fractions (heads %, tails %):", head_frac, tail_frac)

        predictions = calculations.predict_random(3)
        print("Predictions (random):", predictions)

        last_observation = calculations.predict_last()
        print("Prediction (last):", last_observation)
    except Exception as e:
        print(f"Error: {e}")